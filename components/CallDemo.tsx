...
const SCRIPTS: Script[] = [
  ...
  {
    label: "ગુજરાતી",
    scenario: "Payment Reminder · Trading",
    disposition: "Payment Promised",
    turns: [
      { speaker: "agent", text: "નમસ્તે રોહનભાઈ! હું સ્પીક્સીથી બોલી રહી છું. તમારી ₹4,500 ની EMI કાલે due છે — આજે payment કરી શકશો?", ms: 4400 },
      { speaker: "user", text: "હા, કાલે ચોક્કસ કરીશ.", ms: 2400 },
      { speaker: "agent", text: "સરસ! હું કાલે સવારે WhatsApp પર payment link મોકલીશ. આભાર, તમારો દિવસ શુભ રહે!", ms: 3800 },
      { speaker: "user", text: "સારું, આભાર.", ms: 1400 },
      { speaker: "agent", text: "આભાર રોહનભાઈ!", ms: 1800 },
    ],
  },
  {
    label: "ಕನ್ನಡ",
    scenario: "EMI Reminder · Finance",
    disposition: "Payment Promised",
    turns: [
      { speaker: "agent", text: "ನಮಸ್ಕಾರ ರೋಹನ್ ಸರ್! ನಾನು ಸ್ಪೀಕ್ಸಿಯಿಂದ ಮಾತನಾಡುತ್ತಿದ್ದೇನೆ. ನಿಮ್ಮ ₹4,500 EMI ನಾಳೆ due — ಇವತ್ತು payment ಮಾಡಲು ಸಾಧ್ಯವೇ?", ms: 4400 },
      { speaker: "user", text: "ಸರಿ, ನಾಳೆ ಖಂಡಿತ ಮಾಡ್ತೀನಿ.", ms: 2400 },
      { speaker: "agent", text: "ಸರಿ ಸರ್! ನಾಳೆ ಬೆಳಿಗ್ಗೆ WhatsApp ನಲ್ಲಿ payment link ಕಳುಹಿಸುತ್ತೇನೆ. ಧನ್ಯವಾದಗಳು!", ms: 3600 },
      { speaker: "user", text: "ಸರಿ, ಕಳುಹಿಸಿ.", ms: 1600 },
      { speaker: "agent", text: "ಧನ್ಯವಾದಗಳು ಸರ್!", ms: 1800 },
    ],
  },
];
