...
export const metadata: Metadata = {
  title: "Careers",
  description:
    "Join Speaksy — build state-of-the-art voice AI for 10 Indian languages, from Bengaluru & Mumbai. Open roles in ML, engineering, linguistics and go-to-market.",
  alternates: { canonical: "/careers" },
};

const perks = [
  ["Scale", "Real scale, day one", "Your code talks to lakhs of people a day. Latency you shave and accents you fix are heard across India within a sprint."],
  ["Mission", "A mission you can explain to your parents", "We make technology speak their language — literally. Hindi, Tamil, and Marathi matter here as much as Hinglish."],
  ["ESOP", "Meaningful ESOPs", "Early team, real ownership. Wealth creation shouldn't be a metro-English-elite privilege either."],
  ["Health", "Full health cover", "You, spouse, kids and parents. No fine print gymnastics."],
  ["Tools", "Top-of-market tooling", "M-series machines, GPU budget for experiments, and the license to kill any meeting that could've been a webhook."],
  ["Cities", "Bengaluru & Mumbai, flexible", "Offices where the chai is strong; remote weeks when deep work demands it."],
];
...
const roles = [
  ...
  ["Speech Synthesis Engineer — TTS", "Bengaluru", "Make 10 languages sound like home: prosody, honorifics, number reading, sub-150ms first byte."],
  ...
  ["Computational Linguist — Indic Languages", "Mumbai", "Native fluency in two+ of: Marathi, Telugu, Bengali, Tamil, Kannada. Turn cultural register into model behaviour."],
            ...
            {perks.map(([icon, title, body], i) => (
              <Reveal key={title} delay={(i % 3) * 0.08}>
                <div className="card card-hover h-full rounded-2xl p-6">
                  <span className="inline-flex rounded-md bg-brand-500/10 px-2 py-1 text-[11px] font-semibold uppercase tracking-wider text-brand-700">
                    {icon}
                  </span>
              ...
              <Reveal key={title} delay={i * 0.06}>
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-4">
                    <span className="rounded-full bg-black/5 px-3 py-1 text-xs text-muted">{loc}</span>
