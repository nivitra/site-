...
export const industries: Industry[] = [
  {
      slug: "ecommerce",
      name: "E-commerce",
      fullName: "E-commerce, D2C & Retail",
      icon: "ECOM",
      tag: "COD confirmation, NDR rescue, delivery scheduling and refund status.",
      headline: "Kill RTO before it kills your margins.",
      tagline:
        "COD confirmation minutes after checkout, NDR address fixes, delivery scheduling, abandoned-cart recovery and refund status — synced with your OMS in real time and proven pure ROI.",
      sample: {
      ...
      outcomes: [
        ...
        ["24/7", "order-status deflection on inbound"],
      ],
      groups: [
        {
      ...
      faqs: [
        ...
        {
          q: "Will it handle refund disputes?",
          a: "It reads refund status from the OMS and explains the timeline. High-value disputes and goodwill decisions warm-transfer to a human with full context.",
        },
      ],
      keywords: [
        "COD confirmation bot", "RTO reduction voice AI", "NDR resolution automation",
        "ecommerce voice agent India", "abandoned cart recovery voice", "delivery scheduling AI",
      ],
    },
  {
      slug: "automotive",
      name: "Automotive",
      fullName: "Automotive, Dealerships & OEMs",
      icon: "AUTO",
      tag: "Service reminders, test drives, PSF and vehicle delivery updates.",
      headline: "Every service bay full. Every PSF call covered.",
      tagline:
        "Dealership service due reminders, test-drive booking, doorstep pickup coordination, delivery milestones and OEM-mandated post-service feedback — synced with your DMS and proven to recover pure workshop ROI.",
      sample: {
        label: "Service due reminder",
        agent: "Hi Rajesh! Your Creta is due for the 20,000 km service this month. Saturday 10 AM free — shall I book it and arrange pickup?",
        user: "Saturday works. Yes, pickup from home.",
        agent2: "Booked. Pickup between 9–9:30, WhatsApp pin sent. Safe drive!",
        outcome: "Service booked · pickup arranged · DMS updated · reminder set",
      },
      outcomes: [
        ["Higher", "workshop utilisation from due reminders"],
        ["100%", "of post-service feedback calls covered"],
        ["Fewer", "test-drive no-shows with confirmations"],
      ],
      groups: [
        {
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Accessories & care-plan interest", desc: "Present a fixed menu, capture interest, hand off to sales." },
          ],
        },
      ],
      patterns: ["Notify + confirm", "Schedule + reschedule", "Collect structured data", "Fixed-menu offer"],
      escalation:
        "Price negotiation on accessories, goodwill decisions on service complaints, and complex warranty claims go to humans. The agent books, reminds, coordinates logistics and collects structured feedback.",
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Yes. It reads service due dates and booking slots from your dealership DMS, writes back dispositions, and keeps the workshop calendar as the source of truth.",
        },
        {
          q: "Can it book test drives and reduce no-shows?",
          a: "Yes. It qualifies budget and model, books the test drive, and sends day-before confirmations that cut no-shows sharply.",
        },
        {
          q: "Will it sell warranties or negotiate?",
          a: "It presents fixed AMC/warranty menus and captures interest. Closing and any negotiation stay with the sales desk.",
        },
      ],
      keywords: [
        "dealership service reminder AI", "post service feedback calls", "automotive voice AI",
        "test drive booking automation", "DMS voice agent India", "OEM PSF automation",
      ],
    },
  {
      slug: "bfsi-lending",
    ...
    },
  {
      ...
      icon: "INS",
      tag: "Renewals, claim status, KYC and policy servicing — not adjudication.",
      headline: "Renewals that stick. Servicing that scales.",
      tagline:
        "Policy renewal reminders, grace-period saves, claim-status readouts, document checklists and re-KYC scheduling — structured flows that protect persistency without ever adjudicating a claim.",
      sample: {
        label: "Health policy renewal",
        agent: "Namaste Priya ji! Aapki health policy 12 din mein expire ho rahi hai. Kya main WhatsApp par renewal link bhej du?",
        user: "Haan, aur koi claim pending hai kya?",
        agent2: "Koi open claim nahi dikh raha. Link bhej diya — 2 minute mein renew ho jayega. Dhanyavaad!",
        outcome: "Renewal link sent · grace explained · disposition synced to policy admin",
      },
      outcomes: [
        ["Higher", "persistency from structured renewal calls"],
        ["Faster", "document collection before underwriting delays"],
        ["Clear", "claim-status deflection on inbound"],
      ],
      groups: [
        {
          name: "Renewals & persistency",
          items: [
            { title: "Insurance renewal reminders", desc: "Lapse alerts, payment link and grace-period explanation." },
            { title: "Grace-period save calls", desc: "Soft save before lapse; log reason and schedule callback if needed." },
            { title: "Premium due / SI reminders", desc: "For life and ULIP-style products with payment-link push." },
            { title: "Portability interest capture", desc: "Gauge intent, capture current insurer, route to a human advisor." },
          ],
        },
        {
          name: "Servicing & claims logistics",
          items: [
            { title: "Policy-servicing FAQ", desc: "Coverage basics, network-hospital lookup and claim-document checklists (not adjudication)." },
            { title: "Claim status updates", desc: "Read status from the TPA/insurer API; escalate disputes to humans." },
            { title: "Pre-auth document checklists", desc: "What documents are pending before cashless admission." },
            { title: "KYC / re-KYC reminders", desc: "Schedule video-KYC or branch slots before the deadline." },
            { title: "CSAT after claim settlement", desc: "Structured feedback after a closed claim." },
          ],
        },
      ],
      patterns: ["Notify + confirm", "Answer from a bounded KB", "Collect structured data", "Schedule + reschedule"],
      escalation:
        "Claim adjudication, coverage decisions, complaint negotiation and suitability advice stay with licensed humans. The agent renews, reminds, reads status and collects documents — then warm-transfers with context.",
      faqs: [
        {
          q: "Does the agent adjudicate claims?",
          a: "Never. It reads claim status from the TPA/insurer system and walks through document checklists. Any dispute or coverage decision escalates to a licensed human.",
        },
        {
          q: "How does it help persistency?",
          a: "Structured renewal and grace-period calls with payment links recover policies that would otherwise lapse — consistently, in the customer's language, inside compliance windows.",
        },
        {
          q: "Can it answer product questions?",
          a: "Yes, from a bounded knowledge base — coverage basics, network hospitals, waiting periods as documented. Suitability or comparative advice goes to an advisor.",
        },
        {
          q: "Is it compliant for insurance outreach?",
          a: "Flows are scripted, respect calling windows and DND, and never invent coverage. Sensitive decisions always route to humans.",
        },
      ],
      keywords: [
        "insurance renewal voice bot", "claim status voice AI", "policy servicing automation India",
        "insurance persistency calls", "TPA claim status bot", "re-KYC reminder voice agent",
      ],
    },
  {
      slug: "brokerage-capital-markets",
      name: "Brokerage & Capital Markets",
      fullName: "Brokerage, Wealth & Capital Markets",
      icon: "BCM",
      tag: "Account activation, KYC nudges, margin alerts and event outreach — never advice.",
      headline: "Activate accounts. Clear KYC. Never give advice.",
      tagline:
        "Account activation and onboarding, KYC/re-KYC nudges, corporate-action notifications, margin and pledge reminders, and structured feedback — high-volume ops that free advisors for real relationships.",
      sample: {
        label: "KYC completion nudge",
        agent: "Hi Ankit! Your demat account is 80% done — PAN and selfie are in, address proof is still pending. Shall I WhatsApp the upload link?",
        user: "Yes, send it. Can I trade after that?",
        agent2: "Once address proof is verified, activation usually completes same day. Link sent — reply here if you need help.",
        outcome: "KYC link sent · blocker logged · activation pipeline updated",
      },
      outcomes: [
        ["Faster", "account activation completion rates"],
        ["Fewer", "failed trades from incomplete KYC"],
        ["Clear", "ops deflection without investment advice"],
      ],
      groups: [
        {
          name: "Onboarding & KYC",
          items: [
            { title: "Account activation follow-up", desc: "Nudge incomplete demat/trading applications and push the resume link." },
            { title: "KYC / re-KYC document collection", desc: "Pending docs checklist and secure upload link — never advice." },
            { title: "E-sign / IPV scheduling", desc: "Book video IPV slots and send reminders." },
            { title: "Welcome & app onboarding calls", desc: "Guide first login, 2FA and basic navigation from a fixed script." },
          ],
        },
        {
          name: "Ops, alerts & engagement",
          items: [
            { title: "Margin / pledge reminders", desc: "Notify shortfalls and explain the action window; no product push." },
            { title: "Corporate-action notifications", desc: "Rights, buybacks, AGMs — inform and capture intent for a human RM." },
            { title: "Settlement / payout status", desc: "Read status from the back office; escalate exceptions." },
            { title: "Event & webinar RSVP", desc: "Invite, confirm attendance and send join links." },
            { title: "Dormant account reactivation", desc: "Inform, gauge intent, book an RM callback — no suitability pitch." },
            { title: "CSAT / NPS after service", desc: "Structured feedback after support interactions." },
          ],
        },
      ],
      patterns: ["Notify + confirm", "Collect structured data", "Schedule + reschedule", "Answer from a bounded KB"],
      escalation:
        "Investment advice, product suitability, portfolio recommendations and complaint resolution stay with licensed humans. The agent activates, reminds, notifies and routes — never recommends a stock or scheme.",
      faqs: [
        {
          q: "Does the agent give investment advice?",
          a: "Never. It handles operational flows only — KYC, activation, margin alerts, corporate actions and status readouts. Any product or portfolio conversation warm-transfers to a licensed RM.",
        },
        {
          q: "Can it improve activation rates?",
          a: "Yes. Incomplete applications get structured follow-ups with the exact pending step and a secure link, which consistently lifts activation completion.",
        },
        {
          q: "How are margin alerts handled?",
          a: "The agent notifies the shortfall and the action window from your risk system. It does not suggest what to sell — that stays with the client or their advisor.",
        },
        {
          q: "Is this SEBI-safe for a broker?",
          a: "Flows are designed as non-advisory operations. Scripts are bounded, advice is out of scope, and escalations go to licensed humans with full call context.",
        },
      ],
      keywords: [
        "brokerage KYC voice bot", "demat activation automation", "capital markets voice AI",
        "margin alert calls", "SEBI non-advisory voice agent", "wealth ops automation India",
      ],
    },
  {
      slug: "real-estate",
...
export function getIndustry(slug: string): Industry | undefined {
  if (slug === "retail-automotive") {
    return industries.find((i) => i.slug === "ecommerce");
  }
  return industries.find((i) => i.slug === slug);
}

/** First 5 / last 5 for mega-menu columns */
export function industryNavColumns(): [Industry[], Industry[]] {
  const mid = Math.ceil(industries.length / 2);
  return [industries.slice(0, mid), industries.slice(mid)];
}
